...
<body>
<form method="post" action="EmployeesUpdate.do" name="frm">
<table>
	<tr>
...
<table>
	...
	<tr>
		...
		<td>
			<select name="lev">
				<option value="B" <c:if test="${loginUser.lev == 'B'}">selected</c:if>> 일반회원 </option>
				<option value="A" <c:if test="${loginUser.lev == 'A'}">selected</c:if>> 관리자 </option>
			</select>
		</td>
	</tr>
	<tr>
